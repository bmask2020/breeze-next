    ...
    useEffect(() => {
        ...
        const myId = url.substring(28);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/short/product', formData)
               .then(response => 
               ...
               async function getData() {
                const query = await fetch('http://127.0.0.1:8000/api/bra/related');
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/short" rel="tag">Short</Link></span>
                  </div>
                  <div class="btn-add-to-cart">
                      <form onSubmit={addCart} id='medicalPro'>
                        <div class="quantity">
      ...
      <div class="product">
        <div class="product-header">
          <div class="thumb image-swap">
            <Link href={'/underwear/' + val.id}><img src={'http://127.0.0.1:8000/' + val.img} class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="product"/></Link>
            <Link href={'/underwear/' + val.id}><img src={'http://127.0.0.1:8000/' + val.thumbnail} class="product-hover-image img-responsive img-fullwidth" alt="product"/></Link>
          </div>
          <div class="product-button-holder">
            <ul class="shop-icons">
              <li class="item"><Link href={'/underwear/' + val.id} class="button btn-quickview" title="Product quick view"></Link></li>
              <li class="item">
        ...
        <div class="product-details">
          <span class="product-categories"><a href="#" rel="tag">Underwear</a></span>
          <h5 class="product-title"><a href={'/underwear/' + val.id}>{val.name}</a></h5>
          <span class="price">
...
export default dynamic (() => Promise.resolve(Short), {ssr: false})