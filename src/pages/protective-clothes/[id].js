...
function ProtectiveClothesProducts() {
    ...
    useEffect(() => {
        ...
        const myId = url.substring(41);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/protective-clothes-product', formData)
               .then(response => 
               ...
               async function getData() {
                const query = await fetch('http://127.0.0.1:8000/api/protective-clothes/related');
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/" rel="tag">Protective Clothes</Link></span>
                  </div>
      ...
      <div class="product">
        <div class="product-header">
          ...
          <div class="product-button-holder">
            <ul class="shop-icons">
              <li class="item"><Link href={'/lab-coat/' + val.id} class="button btn-quickview" title="Product quick view"></Link></li>
              <li class="item">
        ...
        <div class="product-details">
          <span class="product-categories"><Link href={'/lab-coat/' + val.id} rel="tag">Lab Coat</Link></span>
...
export default dynamic (() => Promise.resolve(ProtectiveClothesProducts), {ssr: false})