    ...
    useEffect(() => {
        ...
        const myId = url.substring(31);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/coverall/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/coverall" rel="tag">Coverall</Link></span>
                  </div>
...
export default dynamic (() => Promise.resolve(Coverall), {ssr: false})