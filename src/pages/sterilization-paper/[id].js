    ...
    useEffect(() => {
        ...
        const myId = url.substring(42);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/sterilization-paper/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/sterilization-paper" rel="tag">Sterilization Paper</Link></span>
                  </div>
...
records.map((val, index) => {
  ...
  let cart = 'SterilizationPaperRelatedPro';
...
export default dynamic (() => Promise.resolve(SterilizationPaper), {ssr: false})