...
export default function SplitDarpe() {
  ...
  useEffect(() => {
      ...
      async function getData() {
          const query = await fetch('http://127.0.0.1:8000/api/split-drape');
  ...
  const addCart = async(e) => {
    ...
    return (
        ...
        <Head>
                ...
                <title>Naltex For Medical Clothes - Split Drape</title>
                        ...
                        <div class="product">
                          <div class="product-header">
                            <div class="thumb image-swap">
                              <Link href={'/split-drape/' + val.id}><img src={'http://127.0.0.1:8000/' + val.img} class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="product"/></Link>
                              <Link href={'/split-drape/' + val.id}><img src={'http://127.0.0.1:8000/' + val.thumbnail} class="product-hover-image img-responsive img-fullwidth" alt="product"/></Link>
                            </div>
                            <div class="product-button-holder">
                              <ul class="shop-icons">
                                <li class="item"><Link href={'/split-drape/' + val.id} class="button btn-quickview" title="Product quick view"></Link></li>
                                <li class="item">
                          ...
                          <div class="product-details">
                            <span class="product-categories"><a href="#" rel="tag">Split Drape</a></span>
                            <h5 class="product-title"><a href={'/split-drape/' + val.id}>{val.name}</a></h5>
                            <span class="price">
