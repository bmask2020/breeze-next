    ...
    useEffect(() => {
        ...
        const myId = url.substring(34);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/split-drape/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/split-drape" rel="tag">Split Drape</Link></span>
                  </div>
...
export default dynamic (() => Promise.resolve(SplitDrape), {ssr: false})