    ...
    useEffect(() => {
        ...
        const myId = url.substring(31);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/lab-coat/product', formData)
               .then(response => 
               ...
               async function getData() {
                const query = await fetch('http://127.0.0.1:8000/api/lab-coat/related');
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/lab-coat" rel="tag">Lab Coat</Link></span>
                  </div>
      ...
      <div class="product">
        <div class="product-header">
          <div class="thumb image-swap">
            <Link href={'/coverall/' + val.id}><img src={'http://127.0.0.1:8000/' + val.img} class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="product"/></Link>
            <Link href={'/coverall/' + val.id}><img src={'http://127.0.0.1:8000/' + val.thumbnail} class="product-hover-image img-responsive img-fullwidth" alt="product"/></Link>
          </div>
          <div class="product-button-holder">
            <ul class="shop-icons">
              <li class="item"><Link href={'/coverall/' + val.id} class="button btn-quickview" title="Product quick view"></Link></li>
              <li class="item">
        ...
        <div class="product-details">
          <span class="product-categories"><a href="#" rel="tag">Coverall</a></span>
          <h5 class="product-title"><a href={'/coverall/' + val.id}>{val.name}</a></h5>
          <span class="price">
...
export default dynamic (() => Promise.resolve(IsolationSuits), {ssr: false})