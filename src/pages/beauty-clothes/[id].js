...
function BeautyClothesProducts() {
    ...
    useEffect(() => {
        ...
        const myId = url.substring(37);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/beauty-clothes-product', formData)
               .then(response => 
               ...
               async function getData() {
                const query = await fetch('http://127.0.0.1:8000/api/beauty-clothes/related');
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/" rel="tag">Spa & Hygiene</Link></span>
                  </div>
                  <div class="btn-add-to-cart">

                  <form onSubmit={addCart} id='beautyPro'>
    ...
    <div class="isotope-item-inner">
      <div class="product">
        ...
        <div class="product-details">
          <span class="product-categories"><a href="#" rel="tag">Shorts</a></span>
...
export default dynamic (() => Promise.resolve(BeautyClothesProducts), {ssr: false})