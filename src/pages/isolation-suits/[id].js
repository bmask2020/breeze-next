    ...
    useEffect(() => {
        ...
        const myId = url.substring(38);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/isolation-suits/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/isolation-suits" rel="tag">Isolation Suits</Link></span>
                  </div>
...
records.map((val, index) => {
  ...
  let cart = 'IsolationSuitsRelatedPro';
