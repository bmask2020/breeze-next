    ...
    useEffect(() => {
        ...
        const myId = url.substring(35);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/pillow-cover/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/pillow-cover" rel="tag">Pillow Cover</Link></span>
                  </div>
...
records.map((val, index) => {
  ...
  let cart = 'PillowCoverRelatedPro';
  return(
...
export default dynamic (() => Promise.resolve(PillowCover), {ssr: false})