    ...
    useEffect(() => {
        ...
        const myId = url.substring(35);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/patient-gown/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/patient-gown" rel="tag">Patient Gown</Link></span>
                  </div>
...
records.map((val, index) => {
  ...
  let cart = 'PatientGownRelatedPro';
...
export default dynamic (() => Promise.resolve(PatientGown), {ssr: false})