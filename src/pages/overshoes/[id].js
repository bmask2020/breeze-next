    ...
    useEffect(() => {
        ...
        const myId = url.substring(32);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/overshoes/product', formData)
               .then(response => 
               ...
               async function getData() {
                const query = await fetch('http://127.0.0.1:8000/api/overshoes/related');
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/overshoes" rel="tag">Overshoes</Link></span>
                  </div>
...
export default dynamic (() => Promise.resolve(Overshoes), {ssr: false})