    ...
    useEffect(() => {
        ...
        const myId = url.substring(26);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/bra/product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/bra" rel="tag">Bra</Link></span>
                  </div>
...
export default dynamic (() => Promise.resolve(Bra), {ssr: false})