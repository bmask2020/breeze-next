...
function MedicalClothesProducts() {
    ...
    useEffect(() => {
        ...
        const myId = url.substring(38);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/medical-clothes-product', formData)
               .then(response => 
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/" rel="tag">Medical Clothes</Link></span>
                  </div>
      ...
      <div class="product">
        <div class="product-header">
          ...
          <div class="product-button-holder">
            <ul class="shop-icons">
              <li class="item"><Link href={'/surgical-gown/' + val.id} class="button btn-quickview" title="Product quick view"></Link></li>
              <li class="item">
...
export default dynamic (() => Promise.resolve(MedicalClothesProducts), {ssr: false})