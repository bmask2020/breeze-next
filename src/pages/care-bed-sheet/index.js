...
export default function CareBedSheet() {
  ...
  useEffect(() => {
      ...
      async function getData() {
          const query = await fetch('http://127.0.0.1:8000/api/care-bed-sheet');
  ...
  const addCart = async(e) => {
    ...
    return (
        ...
        <Head>
                ...
                <title>Naltex For Medical Clothes - Care Bed Sheet</title>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title">Care Bed Sheet</h2>
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs">
                  <span><Link href="/" rel="home">Home</Link></span>
                  <span><i class="fa fa-angle-right"></i></span>
                  <span><a href="#">Care Bed Sheet</a></span>
