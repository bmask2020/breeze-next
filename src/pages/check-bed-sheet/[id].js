    ...
    useEffect(() => {
        ...
        const myId = url.substring(38);
          ...
          formData.append('id', myId);
           ...
           axios
               .post('http://127.0.0.1:8000/api/check-bed-sheet/product', formData)
               .then(response => 
               ...
               async function getData() {
                const query = await fetch('http://127.0.0.1:8000/api/care-bed-sheet/related');
              ...
              <div class="col-md-6">
                <div class="product-summary">
                  ...
                  <div class="product_meta">
                    ...
                    <span class="posted_in">Category: <Link href="/check-bed-sheet" rel="tag">Check Bed Sheet</Link></span>
                  </div>
                ...
                <div id="gallery-holder-618422" class="isotope-layout grid-4 gutter-15 clearfix lightgallery-lightbox">
                   ...
                   
                  {
                    ...
                    records.map((val, index) => {
                      ...
                      let cart = 'CheckBedSheetRelatedPro';
                          ...
                          <div class="product">
                            <div class="product-header">
                              <div class="thumb image-swap">
                                <Link href={'/care-bed-sheet/' + val.id}><img src={'http://127.0.0.1:8000/' + val.img} class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="product"/></Link>
                                <Link href={'/care-bed-sheet/' + val.id}><img src={'http://127.0.0.1:8000/' + val.thumbnail} class="product-hover-image img-responsive img-fullwidth" alt="product"/></Link>
                              </div>
                              <div class="product-button-holder">
                                <ul class="shop-icons">
                                  <li class="item"><Link href={'/care-bed-sheet/' + val.id} class="button btn-quickview" title="Product quick view"></Link></li>
                                  <li class="item">
                            ...
                            <div class="product-details">
                              <span class="product-categories"><a href="#" rel="tag">Care Bed Sheet</a></span>
                              <h5 class="product-title"><a href={'/care-bed-sheet/' + val.id}>{val.name}</a></h5>
                              <span class="price">
