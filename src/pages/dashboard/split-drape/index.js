...
export default function SplitDrape() {
           ...
           <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style={{padding:'1rem 1rem'}}>
                                <h4 class="card-title">Split Drape</h4>
                                <Link href="/dashboard/split-drape/add" class="btn  btn-square btn-warning">Add Product</Link>
                            </div>
                            <div class="card-body">
