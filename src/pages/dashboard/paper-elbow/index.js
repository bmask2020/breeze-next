           ...
           <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style={{padding:'1rem 1rem'}}>
                                <h4 class="card-title">Paper Elbow</h4>
                                <Link href="/dashboard/paper-elbow/add" class="btn  btn-square btn-warning">Add Product</Link>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
															<Link class="dropdown-item" href={'/dashboard/paper-elbow/' + val.id}>Edit</Link>
															<Link class="dropdown-item" href={'/dashboard/paper-elbow/delete/' + val.id}>Delete</Link>
														</div>
													</div>
												</td>
                                            </tr>
