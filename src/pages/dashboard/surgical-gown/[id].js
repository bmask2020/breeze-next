...
export default function surgicalGownEdit() {
    ...
    useEffect(() => {
        ...
        const surgicalGown = async () => {
           ...
           formData.append('id', myId);
            ...
            axios
                .post('http://127.0.0.1:8000/api/surgical-gown/edit', formData)
                .then(response => 
    ...
    const surgicalGown = async (e) => {
       ...
       formData.append('description', description);
        ...
        axios
            .post('http://127.0.0.1:8000/api/surgical-gown/update', formData)
            .then(response => 
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
