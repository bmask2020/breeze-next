...
export default function UnderwearEdit() {
    ...
    useEffect(() => {
        ...
        const patientGown = async () => {
           ...
           formData.append('id', myId);
            ...
            axios
                .post('http://127.0.0.1:8000/api/underwear/edit', formData)
                .then(response => 
    ...
    const CheckBedSheet = async (e) => {
       ...
       formData.append('description', description);
        ...
        axios
            .post('http://127.0.0.1:8000/api/underwear/update', formData)
            .then(response => 
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                ...
                <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header" style={{padding:'1rem'}}>
                                <h4 class="card-title">Edit Underwear</h4>
                            </div>
                            <div class="card-body">
