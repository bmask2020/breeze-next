           ...
           <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style={{padding:'1rem 1rem'}}>
                                <h4 class="card-title">Sterilization Paper</h4>
                                <Link href="/dashboard/sterilization-paper/add" class="btn  btn-square btn-warning">Add Product</Link>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
															<Link class="dropdown-item" href={'/dashboard/sterilization-paper/' + val.id}>Edit</Link>
															<Link class="dropdown-item" href={'/dashboard/sterilization-paper/delete/' + val.id}>Delete</Link>
														</div>
													</div>
												</td>
                                            </tr>
