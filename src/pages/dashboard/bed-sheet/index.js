           ...
           <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style={{padding:'1rem 1rem'}}>
                                <h4 class="card-title">Bed Sheet</h4>
                                <Link href="/dashboard/bed-sheet/add" class="btn  btn-square btn-warning">Add Product</Link>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
															<Link class="dropdown-item" href={'/dashboard/bed-sheet/' + val.id}>Edit</Link>
															<Link class="dropdown-item" href={'/dashboard/bed-sheet/delete/' + val.id}>Delete</Link>
														</div>
													</div>
												</td>
                                            </tr>
